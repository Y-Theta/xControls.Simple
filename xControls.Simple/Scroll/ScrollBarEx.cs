...
namespace xControl.Simple.Scroll
{
    ...
    /// 自定义滚动条，暴露原属性
    /// </summary>
    public sealed class ScrollBarEx : ScrollBar
    {
        #region Properties
        ...
        public static readonly DependencyProperty IncreaseButtonVertivalProperty =
            DependencyProperty.Register("IncreaseButtonVertival", typeof(Style),
                typeof(ScrollBarEx), new PropertyMetadata(null));
        ...
        static ScrollBarEx()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ScrollBarEx), new FrameworkPropertyMetadata(typeof(ScrollBarEx)));
        }
        #endregion
    }
}
